...
// Landing fade-in
// Runs on DOM ready, not window load, so the animation is not held back
// until every image on the page has finished downloading
$(document).ready(function() {
...
$(window).on("load resize", scaleLandingText);
$(document).ready(scaleLandingText); // Center immediately, before images finish
